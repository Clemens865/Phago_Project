...
fn default_sense_radius() -> f64 {
    5.0
}
fn default_edge_decay() -> f64 {
    0.01
}
fn default_prune_threshold() -> f64 {
    0.05
}
fn default_tentative_weight() -> f64 {
    0.1
}
...
fn default_signal_decay_rate() -> f64 {
    0.05
}
fn default_signal_removal_threshold() -> f64 {
    0.01
}
fn default_trace_decay_rate() -> f64 {
    0.02
}
fn default_trace_removal_threshold() -> f64 {
    0.01
}
fn default_edge_decay_rate() -> f64 {
    0.005
}
fn default_edge_prune_threshold() -> f64 {
    0.05
}
fn default_staleness_factor() -> f64 {
    1.5
}
fn default_maturation_ticks() -> u64 {
    50
}
fn default_max_edge_degree() -> usize {
    30
}
...
fn default_similarity_influence() -> f64 {
    0.5
}
